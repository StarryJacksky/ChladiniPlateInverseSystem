...
- Case: `w8_ic_sprint1_sbs`
- Target: `data/processed_targets/target_binary.npy`
- COMSOL export path: `data/comsol_frequency_exports/w8_ic_sprint1_sbs`
- Frequency samples: `6`
- Frequency range: `233.300-950.200 Hz`
...
|---:|---:|---:|---:|---:|---:|---:|
| 1 | 687.700 | 0.0170 | 0.0294 | 1.725 | 0.115 | 0.191 |
| 2 | 233.300 | 0.0941 | 0.1021 | 1.086 | 0.090 | 0.136 |
| 3 | 491.700 | 0.0652 | 0.0711 | 1.091 | 0.098 | 0.135 |
| 4 | 301.300 | 0.0676 | 0.0742 | 1.098 | 0.117 | 0.111 |
| 5 | 843.200 | 0.1605 | 0.1483 | 0.924 | 0.113 | 0.097 |
| 6 | 950.200 | 0.1510 | 0.1250 | 0.828 | 0.113 | 0.063 |

## Decision / 判据与结论

- Best frequency: `687.700 Hz`
- Best valley contrast: `1.725`
