...
- Case: `w8_ic_sprint1_baseline`
- Target: `data/processed_targets/target_binary.npy`
- COMSOL export path: `data/comsol_frequency_exports/w8_ic_sprint1_baseline`
- Frequency samples: `6`
- Frequency range: `220.200-882.600 Hz`
...
|---:|---:|---:|---:|---:|---:|---:|
| 1 | 220.200 | 0.0242 | 0.0364 | 1.507 | 0.090 | 0.191 |
| 2 | 481.600 | 0.0587 | 0.0634 | 1.080 | 0.094 | 0.138 |
| 3 | 882.600 | 0.0518 | 0.0601 | 1.161 | 0.108 | 0.135 |
| 4 | 714.500 | 0.0706 | 0.0696 | 0.986 | 0.106 | 0.122 |
| 5 | 837.700 | 0.0900 | 0.0910 | 1.011 | 0.112 | 0.101 |
| 6 | 318.500 | 0.1474 | 0.1431 | 0.970 | 0.110 | 0.094 |

## Decision / 判据与结论

- Best frequency: `220.200 Hz`
