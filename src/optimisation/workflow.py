...
def run_design_workflow(config: dict, generation: int | None = None, limit: int | None = None, num_modes: int | None = None, simulate: bool = True, progress=None, cancel_check=None) -> dict:  # 运行完整设计工作流 / Run complete design workflow
