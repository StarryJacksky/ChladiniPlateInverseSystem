...
- Case: `pipeline_diagonal_v1_w6_pipeline_diagonal_v1_v1`
- Target: `data/processed_targets/target_binary.npy`
- COMSOL export path: `data/comsol_frequency_exports/pipeline_diagonal_v1_w6_pipeline_diagonal_v1_v1`
- Frequency samples: `9`
...
|---:|---:|---:|---:|---:|---:|---:|
| 1 | 200.000 | 0.0250 | 0.0359 | 1.437 | 0.091 | 0.185 |
| 2 | 540.000 | 0.0364 | 0.0560 | 1.538 | 0.113 | 0.174 |
| 3 | 860.000 | 0.0323 | 0.0442 | 1.367 | 0.105 | 0.163 |
| 4 | 750.000 | 0.0495 | 0.0562 | 1.136 | 0.115 | 0.128 |
| 5 | 640.000 | 0.0519 | 0.0492 | 0.948 | 0.096 | 0.123 |
| 6 | 474.000 | 0.0690 | 0.0661 | 0.959 | 0.097 | 0.123 |
| 7 | 400.000 | 0.1205 | 0.1217 | 1.010 | 0.093 | 0.120 |
| 8 | 950.000 | 0.1125 | 0.1065 | 0.947 | 0.109 | 0.104 |
| 9 | 300.000 | 0.0837 | 0.0856 | 1.022 | 0.125 | 0.094 |

## Decision / 判据与结论

- Best frequency: `200.000 Hz`
- Best valley contrast: `1.437`
- Best final score: `0.185`
