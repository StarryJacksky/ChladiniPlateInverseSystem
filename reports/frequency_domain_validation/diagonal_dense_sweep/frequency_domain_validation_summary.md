...
- Case: `diagonal_dense_sweep`
- Target: `data/processed_targets/target_binary.npy`
- COMSOL export path: `data/comsol_frequency_exports/diagonal_dense_sweep`
- Frequency samples: `20`
- Frequency range: `100.000-1300.000 Hz`
...
|---:|---:|---:|---:|---:|---:|---:|
| 1 | 620.000 | 0.0192 | 0.0384 | 1.995 | 0.113 | 0.223 |
| 2 | 1300.000 | 0.0478 | 0.0664 | 1.388 | 0.087 | 0.190 |
| 3 | 220.000 | 0.0557 | 0.0683 | 1.228 | 0.082 | 0.173 |
| 4 | 420.000 | 0.0348 | 0.0505 | 1.450 | 0.111 | 0.170 |
| 5 | 140.000 | 0.0623 | 0.0822 | 1.318 | 0.097 | 0.169 |
| 6 | 500.000 | 0.0352 | 0.0483 | 1.374 | 0.113 | 0.163 |
| 7 | 680.000 | 0.0424 | 0.0564 | 1.331 | 0.110 | 0.157 |
| 8 | 100.000 | 0.0385 | 0.0456 | 1.185 | 0.109 | 0.141 |
| 9 | 1000.000 | 0.0425 | 0.0493 | 1.161 | 0.109 | 0.135 |
| 10 | 300.000 | 0.0477 | 0.0541 | 1.134 | 0.113 | 0.132 |

## Decision / 判据与结论

- Best frequency: `620.000 Hz`
- Best valley contrast: `1.995`
- Best final score: `0.223`
