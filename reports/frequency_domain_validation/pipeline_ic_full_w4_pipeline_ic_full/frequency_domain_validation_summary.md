...
- Case: `pipeline_ic_full_w4_pipeline_ic_full`
- Target: `data/processed_targets/target_binary.npy`
- COMSOL export path: `data/comsol_frequency_exports/pipeline_ic_full_w4_pipeline_ic_full`
- Frequency samples: `1`
...
|---:|---:|---:|---:|---:|---:|---:|
| 1 | 636.547 | 0.0494 | 0.0727 | 1.470 | 0.092 | 0.192 |

## Decision / 判据与结论

- Best frequency: `636.547 Hz`
- Best valley contrast: `1.470`
