...
- Case: `pipeline_ic_full_w4_probe`
- Target: `data/processed_targets/target_binary.npy`
- COMSOL export path: `data/comsol_frequency_exports/pipeline_ic_full_w4_probe`
- Frequency samples: `1`
- Frequency range: `636.500-636.500 Hz`
...
|---:|---:|---:|---:|---:|---:|---:|
| 1 | 636.500 | 0.0499 | 0.0732 | 1.467 | 0.092 | 0.192 |

## Decision / 判据与结论

- Best frequency: `636.500 Hz`
- Best valley contrast: `1.467`
- Best final score: `0.192`
