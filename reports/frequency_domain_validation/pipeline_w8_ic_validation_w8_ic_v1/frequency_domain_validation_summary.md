...
- Case: `pipeline_w8_ic_validation_w8_ic_v1`
- Target: `data/processed_targets/target_binary.npy`
- COMSOL export path: `data/comsol_frequency_exports/pipeline_w8_ic_validation_w8_ic_v1`
- Frequency samples: `6`
- Frequency range: `220.210-882.620 Hz`
...
|---:|---:|---:|---:|---:|---:|---:|
| 1 | 220.210 | 0.0242 | 0.0364 | 1.507 | 0.090 | 0.191 |
| 2 | 481.580 | 0.0585 | 0.0630 | 1.078 | 0.094 | 0.138 |
| 3 | 882.620 | 0.0518 | 0.0601 | 1.161 | 0.108 | 0.135 |
| 4 | 714.530 | 0.0705 | 0.0697 | 0.988 | 0.106 | 0.122 |
| 5 | 837.700 | 0.0900 | 0.0910 | 1.011 | 0.112 | 0.101 |
| 6 | 318.530 | 0.1490 | 0.1446 | 0.971 | 0.110 | 0.094 |

## Decision / 判据与结论

- Best frequency: `220.210 Hz`
- Best valley contrast: `1.507`
