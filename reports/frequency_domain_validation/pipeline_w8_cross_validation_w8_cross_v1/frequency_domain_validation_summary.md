...
- Case: `pipeline_w8_cross_validation_w8_cross_v1`
- Target: `data/processed_targets/target_binary.npy`
- COMSOL export path: `data/comsol_frequency_exports/pipeline_w8_cross_validation_w8_cross_v1`
- Frequency samples: `6`
- Frequency range: `345.840-1073.430 Hz`
...
|---:|---:|---:|---:|---:|---:|---:|
| 1 | 765.030 | 0.0131 | 0.0253 | 1.936 | 0.116 | 0.212 |
| 2 | 657.430 | 0.0428 | 0.0596 | 1.392 | 0.105 | 0.170 |
| 3 | 345.840 | 0.0555 | 0.0602 | 1.083 | 0.116 | 0.120 |
| 4 | 1073.430 | 0.0692 | 0.0717 | 1.037 | 0.110 | 0.110 |
| 5 | 467.090 | 0.0639 | 0.0658 | 1.031 | 0.111 | 0.110 |
| 6 | 935.240 | 0.1090 | 0.1097 | 1.007 | 0.116 | 0.096 |

## Decision / 判据与结论

- Best frequency: `765.030 Hz`
- Best valley contrast: `1.936`
- Best final score: `0.212`
