...
- Case: `pipeline_w8_xform_validation_w8_xform_v1`
- Target: `data/processed_targets/target_binary.npy`
- COMSOL export path: `data/comsol_frequency_exports/pipeline_w8_xform_validation_w8_xform_v1`
- Frequency samples: `6`
- Frequency range: `213.920-965.080 Hz`
...
|---:|---:|---:|---:|---:|---:|---:|
| 1 | 641.360 | 0.0137 | 0.0260 | 1.901 | 0.113 | 0.210 |
| 2 | 724.280 | 0.0147 | 0.0281 | 1.909 | 0.115 | 0.210 |
| 3 | 213.920 | 0.0298 | 0.0438 | 1.471 | 0.087 | 0.194 |
| 4 | 965.080 | 0.0341 | 0.0443 | 1.297 | 0.114 | 0.146 |
| 5 | 791.970 | 0.0663 | 0.0780 | 1.176 | 0.111 | 0.138 |
| 6 | 439.710 | 0.2064 | 0.1857 | 0.900 | 0.099 | 0.095 |

## Decision / 判据与结论

- Best frequency: `641.360 Hz`
- Best valley contrast: `1.901`
- Best final score: `0.210`
