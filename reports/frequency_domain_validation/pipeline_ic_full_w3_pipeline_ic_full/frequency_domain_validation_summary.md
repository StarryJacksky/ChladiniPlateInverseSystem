...
- Case: `pipeline_ic_full_w3_pipeline_ic_full`
- Target: `data/processed_targets/target_binary.npy`
- COMSOL export path: `data/comsol_frequency_exports/pipeline_ic_full_w3_pipeline_ic_full`
- Frequency samples: `1`
...
|---:|---:|---:|---:|---:|---:|---:|
| 1 | 636.547 | 0.0238 | 0.0347 | 1.460 | 0.117 | 0.164 |

## Decision / 判据与结论

- Best frequency: `636.547 Hz`
- Best valley contrast: `1.460`
- Best final score: `0.164`
